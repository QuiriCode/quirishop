  ...
  return (
    <Fragment>
      <SEO
        ...
        description="Wishlist page of quiri react minimalist eCommerce template."
      />
                              ...
                              <tr key={key}>
                                <td className="product-thumbnail">
                                  ...
                                  >
                                     <img
                                      className="img-fluid"
                                      src={`data:${wishlistItem.images[0].mimetype};base64,${wishlistItem.images[0].base64content}`}
                                      alt=""
                                    />
                                  </Link>
                                </td>
